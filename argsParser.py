...
def argsParser():
    ...
    ###  finetune setting
    parser.add_argument('--hsi_model_path_1', type=str, default='',
                        help='The path of model to evaluation')
    parser.add_argument('--hsi_model_path_2', type=str, default='',
                        help='The path of model to evaluation')
    parser.add_argument('--hsi_model_path_3', type=str, default='',
                        help='The path of model to evaluation')
    parser.add_argument('--msi_model_path_16', type=str, default='',
                        help='The path of model to evaluation')
    parser.add_argument('--msi_model_path_8', type=str, default='',
                        help='The path of model to evaluation')
    parser.add_argument('--msi_model_path_32', type=str, default='',
                        help='The path of model to evaluation')
    ...
    ##  testing setting
    parser.add_argument('--model_path', type=str, default='./train/cave/net4/model/model_03000.pt',
                        help='The path of model to evaluation')
